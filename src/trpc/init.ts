...
export const createTRPCContext = cache(async () => {
  ...
  // extract and return the user token (jwt) only since the context will be triggered continously, then use the extracted token later for db querying as needed
